...
//////////////////////////////////////////////////
/**
 * @brief Enable cmee mode with mode set
 * 
 * @param dce Modem DCE ojbect
 * @param mode mode of cmee 
 * @return esp_err_t 
 *      -  ESP_OK on success
 *      - ESP_FAIL on error
 */
 ...
 * @return esp_err_t 
 */
esp_err_t ec6x_do_unlock_band (modem_dce_t *ec2x_dce);
