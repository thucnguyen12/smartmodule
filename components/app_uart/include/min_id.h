...
#define MIN_ID_PING_ESP_DEAD 0x25
#define MIN_ID_SEND_SPI_FROM_ESP32 0x11
#define MIN_ID_RECIEVE_SPI_FROM_GD32 0x12
#define MIN_ID_PING_ESP_ALIVE 0x10
#define MIN_ID_SEND_SPI_FROM_ESP32 0x11
#define MIN_ID_RECIEVE_SPI_FROM_GD32 0x12
#define MIN_ID_SEND_HEARTBEAT_MSG 0x13
#define MIN_ID_RECEIVE_HEARTBEAT_MSG 0x14
#define MIN_ID_SEND_BEACON_MSG 0x15
#define MIN_ID_RECEIVE_BEACON_MSG 0x16
#define MIN_ID_SEND_KEY_CONFIG 0x17
